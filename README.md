...
More information about the archiving project can be found on the ArchiveTeam wiki: [Flash](http://archiveteam.org/index.php?title=Flash)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "Flash" project in the Warrior interface.
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, flashdomains-grab will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/flashdomains-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
...
### For Alpine Linux:
    ...
    git clone https://github.com/ArchiveTeam/flashdomains-grab
    cd flashdomains-grab; ./get-wget-lua.sh
...
Have an issue not listed here? Join us on IRC and ask! We can be found at hackint IRC [#flashbang](https://webirc.hackint.org/#irc://irc.hackint.org/#flashbang).
